            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
              {[
                ...
                <a
                  key={s.title}
                  href="/projects"
                  className="group p-8 rounded-2xl border border-slate-200 bg-white hover:border-slate-900 hover:shadow-xl hover:shadow-slate-100 transition-all duration-300 flex flex-col"
                >
                  <h3 className="text-base font-semibold mb-2">{s.title}</h3>
                  <p className="text-sm text-slate-700 font-medium leading-relaxed mb-1">{s.body}</p>
                  <p className="text-sm text-slate-500 leading-relaxed mb-5 flex-1">{s.sub}</p>
                  <span className="inline-flex items-center gap-1.5 text-sm font-medium text-slate-400 group-hover:text-slate-900 transition-colors duration-300">
                    See how it works
